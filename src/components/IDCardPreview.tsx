...
const IDCardPreview = ({
  ...
  return <div id="idCard" className="w-[340px] h-[212px] bg-white rounded-lg shadow-lg overflow-hidden flex">
      ...
      <div className="w-1/3 p-4 flex flex-col items-center justify-between bg-slate-800 rounded-lg">
        <img src="/lovable-uploads/6a764e94-9f71-43d2-b383-4eb9aa3828d2.png" alt="School Logo" className="w-20 mb-2" />
